              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                <div className="flex flex-shrink-0 items-center">
                  <a href='/' className={classNames(
                          'text-gray-300 hover:bg-orange-100 hover:text-black',
                          'rounded-md px-3 py-2  font-xl font-bold text-white'
                        )}>Utsav<br/>Electrotech</a>
                </div>
                    ...
                    {navigation.map((item) => (
                      <a
                        ...
                        className={classNames(
                          'text-gray-300 hover:bg-orange-100 hover:text-black',
                          'rounded-md px-5 py-5 text-sm font-medium'
                        )}
